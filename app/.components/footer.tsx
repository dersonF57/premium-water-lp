    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Links rápidos */}
          <div>
            <h4 className="text-lg font-light uppercase tracking-wider mb-6">Quick Links</h4>
          ...
          {/* Suporte */}
          <div>
            <h4 className="text-lg font-light uppercase tracking-wider mb-6">Support</h4>
            <ul className="space-y-4 text-sm text-gray-400">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-light uppercase tracking-wider mb-6">Stay Hydrated</h4>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center text-xs text-gray-500">
          © 2025 Aqua Montana. All rights reserved. | Designed with purity in mind.
        </div>
      </div>
    </footer>
  );
